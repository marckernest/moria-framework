// City positions are placeholders — map composition (placement, path curves,
// terrain) needs Marck's review before MapCanvas is built. Values are % of canvas.
...
export const stages = [
  {
    ...
    content: {
      title: 'M — Map',
      subtitle: 'The Shire — understanding the problem space',
      intro: 'Something draws you in. You sense there is more beneath the surface, and before you can do anything useful you need to understand what you are actually dealing with. Map is that first act of orientation — not fixing, not diagnosing, just understanding the shape of the world you have entered.',
      steps: [
        {
          heading: 'Identify the system boundaries',
          body: "The system in scope: Pillars Hub (payment processor) to some mechanism to recognize a purchase to Passion.io app access. Out of scope: Joe's content, his warehouse operations, his physical product business. The boundary question that mattered was where does a completed payment end, and where does app access begin? That gap was the entire problem.",
        },
        {
          heading: 'Surface the stocks and flows',
          body: "The stock that mattered was app subscribers — the accumulating pool of paying customers who should have access. The flow that was supposed to feed it was new orders from Pillars Hub. What we found: the flow had effectively stopped. Orders were coming in, money was moving, but zero were reaching Zapier. The stock was being maintained manually, which meant it was fragile, slow, and dependent on a person.",
        },
        {
          heading: 'Find the feedback loops',
          body: "There was a balancing loop that should have existed — new order triggers Zap, Zap grants access, subscriber count grows. That loop had broken and no one knew. The silent failure meant there was no signal going back to Joe that the system was not working. The absence of feedback was itself the core of the problem. Without a visible error, no one was prompted to investigate.",
        },
        {
          heading: 'Spot the assumptions',
          body: 'Joe assumed Zapier was running. Joe assumed the API supported the kind of queries needed. Both were wrong. The Pillars Hub REST API did not support date-based filtering, which meant you could not reliably ask it "what\'s new since last time?" That assumption — that the API would behave like a standard REST API — is what made the Zap appear to work while actually doing nothing.',
        },
        {
          heading: 'Define the desired state',
          body: "Every new Pillars Hub order for product APP 001 automatically triggers app access within minutes, without human intervention. The system is observable — meaning failures surface rather than disappear silently.",
        },
      ],
    },
  },
